...
- **URLs**: Clean routes: `/produs/[slug]`, `/categorii/[slug]`, `/cautare?q=...`. Slugs come from the backend and are used in `generateMetadata` and canonical links (can be added explicitly if needed).
